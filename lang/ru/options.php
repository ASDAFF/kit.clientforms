...
$MESS["CLIENT_FORM_OPTIONS_TITLE"]="Основные настройки";
$MESS["CLIENT_FORM_IBLOCK_ID_TITLE"]="ID инфоблока для результатов форм";
$MESS["CLIENT_FORM_BTN_APPLY"]="Применить";
$MESS["CLIENT_FORM_RE_TITLE"]="Настройки для ReCaptcha";
$MESS["CLIENT_FORM_RE_SITE_KEY"]="Ключ сайта";
$MESS["CLIENT_FORM_RE_SEC_KEY"]="Секретный ключ";
$MESS["CLIENT_FORM_RE_REG_LINK"]="Регистрация сайта";

?>
<?php $MESS["CLIENT_FORM_EVENTS_DESCRIPTION"]='
